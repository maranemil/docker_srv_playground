 ...
 * vals  { 1, 2, 2, 3, 4, 7, 9 }
 * mean (1+2+2+3+4+7+9) / 7	        4 - Sum of values / number of values
 * Median 1, 2, 2, 3, 4, 7, 9	    3 - Middle value greater and lesser halves of a data set
 * Mode 1, 2, 2, 3, 4, 7, 9	        2 - Most frequent value in dataset
 * */
...
function generateARIMAData(): array
{
...
echo "<br/>Auto-regressive Component Lag <table class='table table-border'>";
...
echo "<br/>Auto-regressive Component Moving Average <table class='table table-border'>";
...
echo "<br/>Naive Forecast = (t2 / t1) - 1<table class='table table-border'>";
...
echo "<br/> Autoregressive model AR - alpha 0.3 [value,AR,err]<table class='table table-border'>";
